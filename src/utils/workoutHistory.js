...
const MUSCLE_GROUP_MAP = {
  ...
  'romanian deadlift': ['legs', 'glutes', 'back'],
  'bicep curl': ['biceps'],
  'ez-bar curl': ['biceps'],
  'hammer curl': ['biceps'],
  ...
  'calf raise': ['calves'],
  'hip thrust': ['glutes'],
  'trap bar deadlift': ['back', 'legs', 'glutes', 'core'],
  ...
  // Full body
  'farmer': ['full body', 'core'],
  'sled push': ['full body', 'legs'],
  'kettlebell swing': ['full body', 'glutes', 'hamstrings'],
  'burpee': ['full body'],
